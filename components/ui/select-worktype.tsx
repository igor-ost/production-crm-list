...
export default function SelectWorkType({
  ...
  const selectedWorkType = workType.find((unit) => unit.type === value)
            ...
            <CommandGroup>
              {filteredWorkType.map((workType) => (
                ...
                >
                  ...
                  <Check className={cn("size-4 shrink-0", value === workType.type ? "opacity-100" : "opacity-0")} />
                </CommandItem>
              ))}
            </CommandGroup>
          </CommandList>
