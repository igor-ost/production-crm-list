...
export default function ThreadsUpdateModal({children,onSubmit,color,type,unit,id}:{children:React.ReactNode,id:string,color:string,type:string,unit:string,onSubmit:(id:string,color:string,type:string,unit:string)=>void}) {
